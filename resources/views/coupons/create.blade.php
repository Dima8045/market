...
@section('content')
    @include('coupons.partials.header', ['title' => __('Add Coupon')])
                            ...
                            <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="input-group input-group-alternative">
                                                <input type="text" name="code" id="input-coupon-code" class="form-control" placeholder="{{ __('Code') }}" value="{{ old('code') }}" required autofocus>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="input-group input-group-alternative">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <input class="form-control" name="start_date" placeholder="Start date" type="text" value="{{ old('start_date') }}" autofocus>
                                                </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-alternative">
                                                    ...
                                                    <input class="form-control" name="end_date" placeholder="End date" type="text" value="{{ old('end_date') }}" autofocus>
                                                </div>
                                    ...
                                    <div class="input-coupon-type row">
                                                ...
                                                <div class="input-group input-group-alternative">
                                                    <select class="form-control" name="type" placeholder="{{ __('Coupon type') }}" autofocus>
                                                        @foreach($couponType as $key => $value)
                                                            <option value="{{ $value }}" @if(old('type') == ucfirst($value)) selected @endif>{{ ucfirst($value) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-alternative">
                                                    <input class="form-control" name="amount" placeholder="{{ __('Amount') }}" type="number" max="100" step="0.01" value="{{ old('amount') }}" autofocus>
                                                </div>
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-auto">
                                            <label class="custom-toggle">
                                                <input type="checkbox" name="active" @if(old('active')) checked @endif autofocus>
                                ...
                                <div class="form-group">
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-auto">
                                            <label class="custom-toggle">
                                                <input type="checkbox" name="is_used" @if(old('is_used')) checked @endif autofocus>
                                                <span class="custom-toggle-slider rounded-circle"></span>
                                            </label>
                                        </div>
                                    </div>
